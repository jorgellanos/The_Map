...
public class APIservicios : MonoBehaviour
{
    public List<GameObject> itemsPanel = new List<GameObject>();
    public List<GameObject> servicios = new List<GameObject>();

    // Array que guarda strings
    public string[] items;
    public string[] paths;
    // url de la base de datos MySql, Principal
    public string url = "http://localhost:3000/servicios";

    // Singleton
    public static APIservicios Instance { get; private set; }
