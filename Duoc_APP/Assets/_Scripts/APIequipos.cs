...
public class APIequipos : MonoBehaviour
{
    ...
    public string url = "http://localhost:3000/equipos";

    // Singleton
    public static APIequipos Instance { get; private set; }
    ...
    public void getPaths()
    {
        ...
        {
            string path = getDataValue(items[i + 1], "img_equipo");
            paths[i] = path;
